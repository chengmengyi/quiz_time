                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      QtText("Just one step away from cash withdrawal", fontSize: 12.sp, color: const Color(0xffA36B21), fontWeight: FontWeight.w400),
                      ...
                      InkWell(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            QtText("GO", fontSize: 18.sp, color: Colors.white, fontWeight: FontWeight.w500)
                          ],
                        ),
                      )
                    ],
