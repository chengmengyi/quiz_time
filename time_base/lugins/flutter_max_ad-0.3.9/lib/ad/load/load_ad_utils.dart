...
import 'package:tradplus_sdk/tp_interactive.dart';
import 'package:tradplus_sdk/tp_interstitial.dart';
import 'package:tradplus_sdk/tp_rewardVideo.dart';
...
class LoadAdUtils{
  ...
  _loadAdByType(AdType adType,MaxAdInfoBean bean){
    if(bean.plat=="tradplus"){
      if(FlutterMaxAd.instance.tradplusInitSuccess){
    ...
    switch(adType){
      ...
      case AdType.reward:
        ...
        }else if(bean.plat=="tradplus"){
          if(FlutterMaxAd.instance.tradplusInitSuccess){
            TPRewardVideoManager.loadRewardVideoAd(bean.id);
          }else{
            _loadingList.remove(adType);
          }
        }
      ...
      case AdType.inter:
        ...
        if(bean.plat=="max"){
          ...
          if(FlutterMaxAd.instance.tradplusInitSuccess){
            TPInterstitialManager.loadInterstitialAd(bean.id);
          } else{
            _loadingList.remove(adType);
          }
        }
