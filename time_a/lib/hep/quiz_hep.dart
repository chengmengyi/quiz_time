...
const QtSaveKey<String> currentCategoryBean = QtSaveKey(key: "currentCategoryA", de: QtQuizHep.QH_NK_M);
const QtSaveKey<int> currentQuizIndexBean = QtSaveKey(key: "currentQuizIndexA", de: 0);
const QtSaveKey<int> answerRightBean = QtSaveKey(key: "answerRightBeanA", de: 0);
...
class QuizHep{
  ...
  updateAnswerRight(){
    ...
    SqlHepA.instance.updateTaskCompletedNumRecord(TaskType.quiz);
  }
}