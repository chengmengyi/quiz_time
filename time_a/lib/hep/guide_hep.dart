...
const QtSaveKey<String> newGuideBean = QtSaveKey(key: "newGuideA", de: NewUserGuideStep.rightAnswerFinger);
const QtSaveKey<String> newGuideCompletedTimerBean = QtSaveKey(key: "newGuideCompletedTimerA", de: "");
const QtSaveKey<String> oldGuideBean = QtSaveKey(key: "oldGuideA", de: "");
const QtSaveKey<double> oldGuideWheelAddNumBean = QtSaveKey(key: "oldGuideWheelAddNumBeanA", de: 0.0);
