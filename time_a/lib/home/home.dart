...
import 'package:time_a/hep/call_listener/click_task_listener.dart';
import 'package:time_a/hep/lifecycle_hep.dart';
import 'package:time_a/home/cash/cash_child.dart';
import 'package:time_a/home/quiz/quiz_child.dart';
import 'package:time_base/w/qt_image.dart';

import '../hep/call_listener/change_home_tab_index_listener.dart';

class QuizHomeA extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _QuizHomeAState();
}

class _QuizHomeAState extends State<QuizHomeA> implements ClickTaskListener,ChangeHomeTabIndexListener{
  var tabIndex=0;
