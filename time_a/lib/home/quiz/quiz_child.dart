...
import 'package:time_a/dia/cash_guide.dart';
...
import 'package:time_a/dia/old_user.dart';
import 'package:time_a/dia/open_notifi.dart';
import 'package:time_a/dia/sign_incent.dart';
import 'package:time_a/dia/task_guide.dart';
import 'package:time_a/dia/wheel.dart';
import 'package:time_a/dia/wheel_incent.dart';
import 'package:time_a/hep/call_listener/call_listener_hep.dart';
import 'package:time_a/hep/guide_hep.dart';
...
import 'package:time_a/home/bubble_w.dart';
import 'package:time_a/home/coins_animator.dart';
...
class _QuizChildState extends State<QuizChild> implements GuideListener{
        ...
        Visibility(
          ...
          child: Stack(
            ...
            children: [
              ...
              QtText("Max\$${ValueHepA.instance.getBoxAddMaxCoins()}", fontSize: 10.sp, color: Colors.white, fontWeight: FontWeight.w400),
            ],
          ),
        ),
        SizedBox(
  ...
  _clickAnswer(index,context){
    ...
    Future.delayed(const Duration(milliseconds: 800),(){
      _quizResult=-1;
      SqlHepA.instance.updateTodayAnswerNum();
      if(result){
        ...
        Incent(
          add: ValueHepA.instance.getQuizCoins(),
