            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    QtText(LocalText.congratulation.tr, fontSize: 24.sp, color: const Color(0xffFFFDF5), fontWeight: FontWeight.w600,),
                    SizedBox(height: 36.h,),
                    QtText("+${moneyDou2Str(chooseMoney/ValueHepA.instance.getConversion())}", fontSize: 32.sp, color: const Color(0xffF26805), fontWeight: FontWeight.w500,),
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          counterText: '',
                          isCollapsed: true,
                          hintText: LocalText.pleaseInputYourAccount.tr,
                          hintStyle: TextStyle(
                            fontSize: 14.sp,
                    ...
                    InkWell(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          QtText(LocalText.withdrawNow.tr, fontSize: 18.sp, color: Colors.white, fontWeight: FontWeight.w500,),
                        ],
                      ),
                    )
                  ],
