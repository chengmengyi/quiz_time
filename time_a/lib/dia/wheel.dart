...
class _WheelState extends  State<WheelDialog>{
  ...
  _wheelWidget()=>Stack(
    ...
    children: [
      Transform.rotate(
        ...
        child: QtImage("ffgewfgtew",w: 320.w,h: 320.w,),
      ),
      InkWell(
        onTap: (){
          _startWheel();
  ...
  _startWheel(){
    ...
    var wheelAddNum = ValueHepA.instance.getWheelAddNum();
    int randomAngel=180;
    switch(wheelAddNum){
      case 5:
  ...
  _clickClose(BuildContext context)async{
    ...
    if(widget.wheelFrom==WheelFrom.answer8Guide){
      closeDialog();
      widget.dismissDialog.call(ValueHepA.instance.getWheelAddNum().toDouble());
      return;
    }
    var start = await SqlHepA.instance.checkStartCashTask();
    ShowAdHep.instance.showAd(
