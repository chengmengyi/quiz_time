...
class WheelIncent extends StatelessWidget{
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              QtText("+${moneyDou2Str(wheelAddNum)}", fontSize: 18.sp, color: const Color(0xffF26805), fontWeight: FontWeight.w500)
            ],
          )
        ],
      ),
  ...
  _douBtnWidget()=>InkWell(
    onTap: (){
      TTTTHep.instance.pointEvent(PointName.daily_pop_c,params: {"source_from":"wheel"});
      _clickDou();
    },
    child: Stack(
