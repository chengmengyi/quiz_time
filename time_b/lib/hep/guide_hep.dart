...
const QtSaveKey<String> newGuideBean = QtSaveKey(key: "newGuideB", de: NewUserGuideStep.rightAnswerFinger);
const QtSaveKey<String> newGuideCompletedTimerBean = QtSaveKey(key: "newGuideCompletedTimerB", de: "");
const QtSaveKey<String> oldGuideBean = QtSaveKey(key: "oldGuideB", de: "");
const QtSaveKey<double> oldGuideWheelAddNumBean = QtSaveKey(key: "oldGuideWheelAddNumBeanB", de: 0.0);
