...
import 'package:time_b/hep/sign/sign_hep.dart';
...
import 'package:time_b/home/cash/pay_type_bean.dart';
...
class _CashChildState extends State<CashChild> implements UpdateTaskListener{
  ...
  List<int> moneyList=ValueHepB.instance.getCashMoneyList();
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              top: 8.h,
              right: 12.w,
              child: QtText(moneyDou2Str(InfoHep.instance.userCoins), fontSize: 32.sp, color: Colors.white, fontWeight: FontWeight.w500,),
            )
          ],
        ),
      )
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context,index)=>InkWell(
            ...
            child: Column(
              ...
              children: [
                Container(
                  height: chooseMoneyIndex==index?80.h:60.h,
                  alignment: Alignment.center,
                  margin: EdgeInsets.only(right: 12.w),
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("qtf/f1/${chooseMoneyIndex==index?"jiofjmo":"miomoeg"}.webp"),
                      fit: BoxFit.fill
                    )
                  ),
                  child: Container(
                    ...
                    child: QtText(
                      moneyDou2Str(moneyList[index].toDouble()),
                      fontSize: 24.sp,
  ...
  _clickCashBtn()async{
    ...
    var cashTaskList = await SqlHepB.instance.queryTaskRecordByPayTypeAndChooseMoney(selectedPayType, chooseMoney);
  ...
  _checkShowCashFinger()async{
    ...
    var list = await SqlHepB.instance.queryTaskRecordByPayTypeAndChooseMoney(selectedPayType, chooseMoney);
    setState(() {
